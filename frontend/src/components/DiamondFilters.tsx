...
export const DiamondFilters: React.FC<DiamondFiltersProps> = ({ onFiltersChange }) => {
  ...
  return (
    <div className="diamond-filters">
      <div className="filters-header">
        <h2 className="filters-title">Use the filters below to design your perfect engagement ring</h2>
          ...
          <button className="advance-filter-btn">
            <div>
              ...
              <svg className="dropdown-icon" viewBox="0 0 6 9" fill="none">
                <path d="M5.5 4.5L1.13636 9L0.5 8.41121L4.31818 4.5L0.5 0.588785L1.13636 -2.78164e-08L5.5 4.5Z" fill="black"/>
              </svg>
            </div>
          </button>
        </div>
        ...
        <div className="right-controls">
          ...
          <div className="sort-control">
            ...
            <svg className="dropdown-icon" viewBox="0 0 9 5" fill="none">
              <path d="M4.5 5L0 0.636364L0.588786 0L4.5 3.81818L8.41121 0L9 0.636364L4.5 5Z" fill="black"/>
            </svg>
          </div>
        </div>
        ...
        <div className="view-controls">
          ...
          >
            <svg viewBox="0 0 38 31" fill="none">
              <path d="M8.83284 6C7.68178 6 6.74951 6.67123 6.74951 7.5C6.74951 8.32877 7.68178 9 8.83284 9H29.6662C30.8172 9 31.7495 8.32877 31.7495 7.5C31.7495 6.67123 30.8172 6 29.6662 6H8.83284Z" fill="#3C3C3C"/>
              <path d="M8.83284 14C7.68178 14 6.74951 14.6712 6.74951 15.5C6.74951 16.3288 7.68178 17 8.83284 17H29.6662C30.8172 17 31.7495 16.3288 31.7495 15.5C31.7495 14.6712 30.8172 14 29.6662 14H8.83284Z" fill="#3C3C3C"/>
              <path d="M6.74951 23.5C6.74951 22.6712 7.68178 22 8.83285 22H29.6662C30.8172 22 31.7495 22.6712 31.7495 23.5C31.7495 24.3288 30.8172 25 29.6662 25H8.83285C7.68178 25 6.74951 24.3288 6.74951 23.5Z" fill="#3C3C3C"/>
            </svg>
          </button>
        </div>
      </div>
